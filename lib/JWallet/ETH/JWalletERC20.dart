...
class JWalletERC20 extends JWalletETH {
  ...
  JWalletERC20(JWalletETH ethWallet, $erc20.Data erc20Info)
      : super(ethWallet.name, ethWallet.mainPath, ethWallet.endPoint, ethWallet.keyStore) {
  ...
  //Json构造函数
  JWalletERC20.fromJson(Map<String, dynamic> json) : super.fromJson(json) {
  ...
  Future<ResultString> buildERC20Abi($erc20.Data info, String address, String amountInWei) async {
    return JuBiterPlugin.ETHBuildERC20Abi(
        contextID, info.tokenEname, info.tokenDecimal, info.tokenAddr, address, amountInWei);
  }
